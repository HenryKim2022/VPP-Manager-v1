                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <select class="select2 form-control form-control-lg"
                                                                            edit_dws_id={{ $loadDataWS->id_project }}
                                            ...
                                            <table class="bordered-layout border-accent-1">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pl-2">: </td>
                                                        <td>{{ \Carbon\Carbon::parse($loadDataWS->arrival_time_dws)->isoFormat($cust_time_format) }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><strong>FINISH TIME</strong></td>
                                                        <td class="pl-2">: </td>
                                                        <td>{{ \Carbon\Carbon::parse($loadDataWS->finish_time_dws)->isoFormat($cust_time_format) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                ...
                                <tbody>
                                    @foreach ($loadDataWS['task'] as $relDWS)
                                        <tr>
                                            ...
                                            <td>
                                                {{-- {{ $loadDataWS['monitoring']->category }} --}}
                                                {{-- {{  $relDWS->getcategory->category  }} --}}
