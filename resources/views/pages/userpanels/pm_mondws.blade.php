                        ...
                        <div class="card-body p-1">
                            <table id="daftarLoginKaryawanTable" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($loadDaftarMonDWSFromDB as $monitor)
                                        <tr>
                                            <td>{{ $monitor->id_monitoring ?: '-' }}</td>
                                            <td>
                                                <div class="dropdown d-lg-block d-sm-block d-md-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        ...
                                                        <a class="edit-record dropdown-item d-flex align-items-center"
                                                            edit_karyawan_id_value = "{{ $monitor->id_karyawan ?: 0 }}"
                                                        ...
                                                        <a class="delete-record dropdown-item d-flex align-items-center"
                                                            del_karyawan_id_value = "{{ $monitor->id_karyawan ?: 0 }}"
                                            ...
                                            <td>{{ $monitor->na_karyawan ?: '-' }}</td>

                                            <td>{{ $monitor->alamat_karyawan ?: '-' }}</td>
                                            <td>{{ $monitor->notelp_karyawan ?: '-' }}</td>
                                            <td>
                                                @if ($monitor->foto_karyawan !== null)
                                                    <div class="d-flex align-items-center justify-content-around">
                                                        <img src="{{ 'public/avatar/uploads/' . $monitor->foto_karyawan }}"
                                            ...
                                            <td>{{ $monitor->tlah_karyawan ?: '-' }}</td>
                                            <td>
                                                @if ($monitor->tglah_karyawan)
                                                    {{ \Carbon\Carbon::parse($monitor->tglah_karyawan)->isoFormat('DD MMMM YYYY') }}
                                                @else
                                                    -
                                                @endif
                                            </td>

                                            <td>{{ $monitor->agama_karyawan ?: '-' }}</td>

                                            <td>
                                                @if ($monitor->created_at)
                                                    {{ \Carbon\Carbon::parse($monitor->created_at)->isoFormat($cust_date_format) }}
                                                @else
                                                    -
                                                @endif
                                            </td>
                                            <td>
                                                @if ($monitor->updated_at)
                                                    {{ \Carbon\Carbon::parse($monitor->updated_at)->isoFormat($cust_date_format) }}
                                                @else
                                                    -
                                                @endif
                                            </td>
