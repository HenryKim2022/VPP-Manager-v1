 <div class="modal fade text-left modal-success" id="reset_karyawanModal" tabindex="-1" role="dialog"
     ...
     <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form class="row g-2 needs-validation mt-1" method="POST" action="{{ route('m.emp.reset') }}" novalidate>
                     @csrf
                     <div class="container" style="text-align: justify;">
                         <h6 class="text-center">
                             Are you sure want to <a class="text-warning">reset all of role records?</a> This action <a
