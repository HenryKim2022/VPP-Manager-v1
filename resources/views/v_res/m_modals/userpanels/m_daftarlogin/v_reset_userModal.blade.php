 <div class="modal fade text-left modal-success" id="reset_userModal" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel113" aria-hidden="true">
     <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
         <div class="modal-content">
             <div class="modal-header">
                 <h5 class="modal-title" id="myModalLabel113">Reset All User Records?</h5>
                 ...
                 <form class="row g-2 needs-validation mt-1" method="POST" action="{{ route('m.user.reset') }}" novalidate>
                     ...
                     <div class="container" style="text-align: justify;">
                         <h6 class="text-center">
                             Are you sure want to <a class="text-warning">reset all of users records?</a> This action <a
