     ...
     <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                <form action="{{ route('m.projects.add') }}" method="POST"
                        ...
                        <div class="col-xl-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-merge" id="project-id" name="project-id"
                                    placeholder="e.g. PRJ-24-00001" aria-describedby="project-id" tabindex="4"></input>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-merge" id="project-name" name="project-name"
                                    placeholder="e.g. CONTROL UNIT CU310 - 2DP TYPE 6SL3040..." aria-describedby="project-name" tabindex="4"></input>
                            </div>
                        </div>
