...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tb_task', function (Blueprint $table) {
            ...
            $table->string('na_task')->nullable();
            $table->date('start_time_task')->nullable();
            $table->string('descb_task')->nullable();
            $table->integer('progress_actual_task')->nullable();
            $table->integer('progress_current_task')->nullable();
